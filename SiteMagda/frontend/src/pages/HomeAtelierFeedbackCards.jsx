...
export default function HomeAtelierFeedbackCards() {
  ...
  return (
    <div className="bg-paper">
      ...
      {/* Feedback — "Testimonial Cards": a gallery of proof instead of a
          pull-quote — every testimonial gets the same bordered, flat-card
          treatment the site already uses for the pull-quote panel on Home,
          just applied evenly across all five. */}
      <section className="bg-paper py-24 md:py-36 border-t border-ink/10">
        <div className="mx-auto max-w-7xl px-6 md:px-8">
          <Reveal className="mb-14 md:mb-16 max-w-xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            <Reveal className="md:col-span-2 border border-ink/10 p-8 md:p-10">
            ...
            {MORE_TESTIMONIALS.map((t, i) => (
              <Reveal key={t.author} delay={i * 80} className="border border-ink/10 p-8">
