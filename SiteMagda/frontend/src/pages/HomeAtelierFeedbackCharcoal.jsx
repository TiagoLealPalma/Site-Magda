...
export default function HomeAtelierFeedbackCharcoal() {
  ...
  return (
    <div className="bg-paper">
      ...
      {/* Feedback — "Charcoal Plate": the section that finally breaks from
          paper entirely, a full dark plate carrying every testimonial at
          once, no carousel. */}
      <section className="relative bg-charcoal py-28 md:py-36 overflow-hidden">
        <div className="relative mx-auto max-w-4xl px-6 md:px-8 text-center">
          <Reveal>
            <p className="font-mono text-xs tracking-[0.3em] text-gold-soft uppercase mb-6">Feedback</p>
            <p className="font-display text-3xl md:text-5xl leading-snug text-paper">
        ...
        <div className="relative mx-auto max-w-6xl px-6 md:px-8 mt-32 md:mt-48 grid grid-cols-1 sm:grid-cols-2 gap-x-12 gap-y-12 md:gap-y-14 border-t border-paper/10 pt-16">
          {MORE_TESTIMONIALS.map((t, i) => (
            <Reveal key={t.author} delay={i * 120}>
              <p className="text-paper/70 leading-relaxed">“{t.text}”</p>
              <p className="mt-4 font-mono text-xs tracking-widest uppercase text-gold-soft">
                {t.author}
              </p>
            </Reveal>
          ))}
